...
import uk.ac.mmu.advprog.blackjacksim.strategy.AlwaysStick;
import uk.ac.mmu.advprog.blackjacksim.strategy.HitSoftSeventeen;
import uk.ac.mmu.advprog.blackjacksim.strategy.StickAtEighteen;
import uk.ac.mmu.advprog.blackjacksim.strategy.StickAtSeventeenStrategy;
import uk.ac.mmu.advprog.blackjacksim.strategy.StickAtThreeCards;
...
public class Game {
	...
	static final Player[] PLAYERS = {
		new Player(1,new AlwaysStick()),
		new Player(2,new HitSoftSeventeen()),
		new Player(3,new AlwaysStick())
	};
